...
| 7 | — | Operation Registry | Implement the immutable operation registry and backend-generated manifest. | Planned |
| 8 | — | Validation Model | Define and apply declarative operation validation. | Planned |
| 9 | — | REST API | Expose operation discovery and execution through the HTTP API. | Planned |
| 10 | — | React Integration | Replace the mock boundary with the backend API and verify contract compatibility. | Planned |
| 11 | — | Docker & Runtime | Add local service execution and graceful runtime shutdown. | Planned |
| 12 | — | Documentation & Final Review | Complete acceptance documentation, verification, debt review, and final architecture review. | Planned |
