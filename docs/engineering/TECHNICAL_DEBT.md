...
| TD-002 | Manifest `validations` field is always `[]`. Client-side validation (divisor ≠ 0, radicand ≥ 0, percentage 0–100) is disabled until ABA-006 delivers the declarative validation engine. | Resolved in ABA-006. | Closed |
